...
p = win.addPlot()
p.setXRange(-0.5, 0.5)
p.setYRange(0, 10) # Does not work well by changing from 1.5-10. Look through some backend code
p.setLabel('left', text='Y position (m)')
p.setLabel('bottom', text='X position (m)')
s = p.plot([], [], pen=None, symbol='o')
win.show()

# Add some other plots for the code. Doppler Plot and Range profile
# Main loop
detObj = {}
frameData = {}
currentIndex = 0
